...
const getTop10UsersByFollowers = (users: RankUser[]) => {
  users.sort((a, b) => b.followers - a.followers);
  return users.slice(0, 10);
};

const getTop10UsersByPublicContributions = (users: RankUser[]) => {
  users.sort((a, b) => b.publicContributions - a.publicContributions);
  return users.slice(0, 10);
};

const getTop10UsersByTotalContributions = (users: RankUser[]) => {
  users.sort((a, b) => {
